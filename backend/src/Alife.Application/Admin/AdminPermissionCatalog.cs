...
public static class AdminPermissionCatalog
{
    ...
    [
        ...
        Permission(ManageEventPackagePolicies, "Manage Event Package policies", "管理活动方案政策", "Publish immutable governance-policy versions and controlled rollout modes; manage policy-enabled approval delegations. This does not itself grant package approval or Event editing.", "发布不可变的活动方案治理政策版本及受控上线模式，并管理政策允许的审批委派；此权限本身不授予活动审批或编辑权。"),
