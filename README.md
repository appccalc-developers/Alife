...
[Open the project overview](https://ccalc.live/project/) · [Open the product page](https://ccalc.live/product) · [Read the system architecture](docs/architecture.md) · [Read the Event overview](docs/events/README.md) · [Read the engineering retrospective](docs/project-retrospective.en.md)
