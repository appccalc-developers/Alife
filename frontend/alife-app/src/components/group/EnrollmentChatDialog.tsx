...
const EnrollmentChatDialog = ({
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end bg-slate-950/45 desktop:items-center desktop:justify-center">
      <button type="button" className="absolute inset-0" aria-label="Close enrollment dialog" onClick={onClose} />
      <section className="relative z-10 flex h-[85vh] w-full flex-col rounded-t-3xl bg-white shadow-2xl desktop:h-[80vh] desktop:max-w-4xl desktop:rounded-3xl">
