...
const EventTemplateAdminView = () => {
  ...
  const validationCode = catalog ? validateEventTemplateAdminForm(form, allowedArchetypes, allowedModules, allowedIcons) : 'archetype'
