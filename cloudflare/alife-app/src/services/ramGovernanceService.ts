...
export const ramService = {
  ...
  syncAction: async (id: string, action: 'retry' | 'review', expectedETag: string) => (await http.post<import('../types/ramGovernance').RamSyncOverview>(`/api/events/${id}/ram/sync/${action}`, { expectedETag })).data,
