...
export const eventOperationsService = {
  ...
  createTask: async (eventId: string, request: { stage?: string; eventOccurrenceId?: string | null; reviewerMemberId?: string | null; title: LocalizedText; description: LocalizedText; assignedMemberId?: string | null; dueUtc?: string | null; isRequired: boolean; requiresApproval: boolean; isRestricted: boolean }) => (await http.post<EventTask>(`/api/events/${eventId}/tasks`, request)).data,
