export type ChurchSiteSection = 'home' | 'sermons' | 'bulletins' | 'announcements' | 'albums' | 'forum' | 'events'
...
export const getChurchSiteSection = (pathname: string, search = ''): ChurchSiteSection | null => {
  ...
  return section === 'events' || section === 'announcements' ? section : 'home'
}

export const getChurchSiteMenu = (language: string, access: { isMember: boolean }) => {
