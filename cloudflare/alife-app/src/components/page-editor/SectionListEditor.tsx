...
const sectionTypeOptions: Array<{ type: SectionType; label: LocalText; description: LocalText; Icon: LucideIcon }> = [
  ...
  { type: 'ReviewedPageCarousel', label: { en: 'Reviewed Page Showcase', zh: '审核页面展示' }, description: { en: 'Present reviewed pages as a floating community, editorial event spread, or editorial index.', zh: '将已审核页面呈现为浮动社区、活动编辑画册或编辑目录。' }, Icon: LayoutList },
