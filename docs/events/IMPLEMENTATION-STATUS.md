...
| <a id="place-resource"></a>[PLACE.RESOURCE](modules/PLACE.RESOURCE.md) | **Current**: venue catalogue, capacity, reservations/conflicts and independent recurring room calendars with release/restore/history | Equipment allocation, setup/close-down/handover/return and typed Session-to-Venue linking |
